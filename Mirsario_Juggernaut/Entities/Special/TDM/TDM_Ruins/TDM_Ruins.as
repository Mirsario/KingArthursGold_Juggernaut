//Based on Base/Entities/Special/TDM/TDM_Ruins/TDM_Ruins.as
//Changes: Replaced archer with crossbowman.
...
void onInit(CBlob@ this)
{
	...
	AddIconToken("$crossbowman_class_icon$", "GUI/MenuItems.png", Vec2f(32, 32), 16); //Changed to crossbowman
	AddIconToken("$change_class$", "/GUI/InteractionIcons.png", Vec2f(32, 32), 12, 2);

	//TDM classes
	addPlayerClass(this, "Knight", "$knight_class_icon$", "knight", "Hack and Slash.");
	addPlayerClass(this, "Crossbowman", "$crossbowman_class_icon$", "crossbowman", "The Ranged Advantage."); //Changed to crossbowman
...
void onTick(CBlob@ this)
{
	if (enable_quickswap) {
		...
		if (blob !is null && blob.isMyPlayer()) {
			if (isInRadius(this, blob) && //blob close enough to ruins
...
{
	if (!canSeeButtons(this, caller) || caller.hasTag("cantChangeClass")) {
		return;
	}
